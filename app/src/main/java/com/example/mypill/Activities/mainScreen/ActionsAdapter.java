...
public class ActionsAdapter extends CursorAdapter {
    ...
    public ActionsAdapter(Context context, Cursor cursor) {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        String body = cursor.getString(cursor.getColumnIndexOrThrow(LocalDBHandler.FeedEntry.COLUMN_NAME_ACTION));
        String priority = cursor.getString(cursor.getColumnIndexOrThrow(LocalDBHandler.FeedEntry.COLUMN_NAME_TIME));
